...
# NOTE: NotificationService calls removed from perform_create, approve, and reject.
# Notifications for these events are handled exclusively by signals.py
...
class ApplicationViewSet(viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        ...
        # Notification is sent by post_save signal in notifications/signals.py
    ...
    def approve(self, request, pk=None):
        ...
        application.save()  # pre_save signal in notifications/signals.py fires here
        ...
        # Notification sent by pre_save signal (notify_application_status_change)
    ...
    def reject(self, request, pk=None):
        ...
        application.admin_comments = request.data.get('comments', '')
        application.save()  # pre_save signal fires here
