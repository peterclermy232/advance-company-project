...
class DepositSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = '__all__'
        read_only_fields = [
            'user', 'transaction_reference', 'created_at', 'updated_at', 'amount'
        ]
    ...
    def validate(self, data):
        ...
        # FIX 5: was exclude(id=self.instance.uuid) — primary key is uuid
        if self.instance:
            existing_deposits = existing_deposits.exclude(pk=self.instance.uuid)
